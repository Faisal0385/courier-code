        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Register New Member</li>
                </ol>
            </nav>
        </div>
            ...
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.register.store') }}">
                        ...
                        <div class="mb-3 row">
                            <label for="name" class="col-sm-3 col-form-label">Shop</label>
                            <div class="col-sm-9">
                                <select class="form-select form-select-md" name="shop" aria-label="Small select example">
                                    <option selected>Select Shop</option>
                                    <option value="1">GM IT</option>
                                    <option value="2">Babugor</option>
                                </select>
                                @error('name')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
