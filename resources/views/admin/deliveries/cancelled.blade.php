...
@section('content')
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-title pe-3">Cancelled Deliveries</div>
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    <li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a>
                    </li>
                    <li class="breadcrumb-item active" aria-current="page">Cancelled Deliveries List</li>
                </ol>
            </nav>
        </div>
    ...
    <div class="row justify-content-start">
            ...
            <div class="row">
                ...
                <div class="col">
                    <div class="card radius-10" style="background: #F5F8FA;">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <h5 class="mb-0 text-black">{{ $pickup_cancel ?? 0 }}</h5>
                                <div class="ms-auto">
                                    <i class='bx bx-user fs-3 text-black'></i>
                                </div>
                            </div>
        ...
        <div class="col-lg-12">
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    {{-- Search --}}
                    <form method="GET" action="{{ route('admin.cancelled.page') }}" class="mb-4">
                        <div class="row g-2 align-items-end">
                            ...
                            <div class="col-md-2 d-grid">
                                ...
                                <a href="{{ route('admin.cancelled.page') }}" class="btn btn-outline-secondary mt-1">
                                    Reset
                                </a>
                            </div>
