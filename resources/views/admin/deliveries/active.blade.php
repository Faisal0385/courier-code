...
@section('content')
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-title pe-3">My Active Lists</div>
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    <li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a>
                    </li>
                    <li class="breadcrumb-item active" aria-current="page">Active List</li>
                </ol>
            </nav>
        </div>
                ...
                <div class="col">
                    <div class="card radius-10" style="background: #F5F8FA;">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center text-black">
                                <p class="mb-0">At delivery hub</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col">
                    <div class="card radius-10" style="background: #F5F8FA;">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center text-black">
                                <p class="mb-0">Assigned for delivery</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col">
                    <div class="card radius-10" style="background: #F5F8FA;">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center text-black">
                                <p class="mb-0">Delivery on hold</p>
                            </div>
                        </div>
                    </div>
                </div>
