            ...
            <div class="col-lg-8 col-md-10">
                <div class="card shadow-sm">
                    <div class="card-header bg-primary text-white">
                        <h5 class="mb-0 text-white"><i class="fas fa-folder-plus me-2"></i> Add Hub</h5>
                    </div>
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.hub.store') }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="name" id="name" class="form-control form-control-sm"
                                    placeholder="Enter Hub name" value="{{ old('name') }}" required>
                            </div>
                            ...
                            <div class="text-end">
                                <button type="submit" class="btn btn-sm btn-success">
                                    <i class="fas fa-check-circle me-1"></i> Add Hub
                                </button>
                            </div>
                        </form>
                    </div>
