...
@section('content')
    <div class="container-fluid">
        <div class="row mb-3">
            <div class="col-lg-12">
                <a class="btn btn-sm btn-outline-primary" href="{{ route('admin.store.inchage.index') }}">
                    <i class="fa fa-arrow-left"></i> Back to Store Incharge List
                </a>
            </div>
        </div>
        <hr>
            ...
            <div class="col-lg-8">
                ...
                <div class="card shadow-sm">
                    <div class="card-header bg-primary text-white">
                        <h5 class="mb-0 text-white"><i class="fas fa-folder-plus me-2"></i> Add Store Incharge</h5>
                    </div>

                    <div class="card-body">
                        <form method="POST" action="{{ route('admin.store.inchage.store') }}">
                            @csrf
