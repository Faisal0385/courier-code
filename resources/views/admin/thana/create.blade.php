        ...
        <div class="row justify-content-start">
            <div class="col-lg-8">
                ...
                <div class="card shadow-sm">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('admin.thana.store') }}">
                            @csrf
                            ...
                            <div class="mb-3 row">
                                {{-- Thana Name --}}
                                <div class="col-sm-12">
                                    <label for="name" class="col-form-label">Thana Name</label>
                                    <input type="text" id="name" name="name"
                                        class="form-control @error('name') is-invalid @enderror" placeholder="Thana Name"
