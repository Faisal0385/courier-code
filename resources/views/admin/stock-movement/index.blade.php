...
@section('content')
    ...
    <div class="card shadow-sm">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('admin.stock.movement.store') }}">
                @csrf
        ...
        <div class="col-lg-12">
            <div class="card shadow-sm">
                <div class="card-header bg-dark text-white fw-semibold">
                    Store Name: <span style="color: yellow">{{ $store_name }}</span>
                </div>
                        ...
                        <tbody>
                            @foreach ($stockMovements as $index => $stockMovement)
                                <tr>
                                    ...
                                    <td>{{ strtoupper($stockMovement->type) }}</td>
