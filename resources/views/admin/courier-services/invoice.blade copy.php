                            ...
                            <tbody>
                                ...
                                @if ($role === 'Admin')
                                    <tr>
                                        ...
                                        <td class="text-end">{{ $data['delivery_fee'] ?? null }} Tk</td>
                                    </tr>
                                    <tr>
                                ...
                                <tr>
                                    <td>Our COD Fee</td>
                                    <td class="text-end">
                                        {{ $data['cod_fee'] + ($data['cod_fee'] * $setup_change['cod_fee']) / 100 ?? null }}
                                        Tk</td>
                                </tr>
                                <tr>
                                    <td><strong>Actual Courier Amount:</strong></td>

                                    @php
                                        $actual_amount = $data['order_amount'] + $data['delivery_fee'] + $data['cod_fee'];
                                    @endphp

                                    <td class="text-end"><strong>{{ $actual_amount }} Tk</strong></td>
                                </tr>
                                <tr>
                                    <td><strong>Merchant Fullfilment Amount:</strong></td>
                                    ...
                                    <td class="text-end"><strong>{{ $merchant_fullfilment_amount }} Tk</strong></td>
                                </tr>
                                <tr>
                                    <td><strong>Merchant Amount:</strong></td>
                                    ...
                                    <td class="text-end"><strong>{{ $merchant_amount }} Tk</strong></td>
