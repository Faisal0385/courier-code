            ...
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.store.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-3 row">
                            <div class="col-sm-4">
                                <label for="city_id" class="col-form-label">City - {{ $store->city }}</label>
                            ...
                            <div class="col-sm-4">
                                <label for="zone_id" class="col-form-label">Zone - {{ $store->zone }}</label>
                            ...
                            <div class="col-sm-4">
                                <label for="area_id" class="col-form-label">Area - {{ $store->area }}</label>
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="mt-3">
                                    <img id="file-ip-1-preview"
                                        src="{{ !empty($store->image) ? asset($store->image) : asset('no_image.jpg') }}"
