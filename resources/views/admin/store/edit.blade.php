...
@section('content')
    ...
    <div class="row mb-3">
        <div class="col-lg-12">
            <a class="btn btn-sm btn-outline-primary" href="{{ route('admin.store.index') }}">
                    ...
                    <form method="POST" action="{{ route('admin.store.update', $id) }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <input type="text" id="owner_name" name="owner_name" class="form-control"
                                    placeholder="Owner Name" value="{{ old('owner_name', $store->owner_name) }}">
                            </div>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <input type="text" id="phone" name="phone" class="form-control" placeholder="Phone"
                                    value="{{ old('phone', $store->primary_phone) }}">
                            </div>
                        ...
                        <div class="mb-3 row">
                            <div class="col-sm-12">
                                ...
                                <textarea id="address" name="address" rows="3" class="form-control" placeholder="Address">{{ old('address', $store->address) }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row">
                            <div class="col-sm-4">
                                <label for="city_id" class="col-form-label"><strong>Selected City -
                                        {{ $cityName }}</strong>
                                </label>
                                <select id="city_id" name="city_id"
                                    class="form-select @error('city_id') is-invalid @enderror">
                                    <option value="">Select City</option>
                                    @foreach ($cities['data']['data'] ?? [] as $c)
                            ...
                            <div class="col-sm-4">
                                <label for="zone_id" class="col-form-label">
                                    <strong>Selected Zone - {{ $zoneName }}</strong></label>
                            ...
                            <div class="col-sm-4">
                                <label for="area_id" class="col-form-label">
                                    <strong>Selected Area - {{ $areaName }}</strong></label>
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="mt-3">
                                    <img id="file-ip-1-preview"
                                        src="{{ !empty($store->logo) ? asset($store->logo) : asset('no_image.jpg') }}"
