...
Route::middleware(['auth'])->group(function () {
    ...
    ## Store
    Route::get('admin/store/index', [StoreController::class, 'index'])->name('admin.store.index');
    Route::get('admin/store/list/page', [StoreController::class, 'list'])->name('admin.store.list.page');
    Route::get('admin/store/add', [StoreController::class, 'add'])->name('admin.store.add');
    ...
    ## Store Courier
    Route::get('admin/courier/list/page', [StoreController::class, 'courierList'])->name('admin.courier.list.page');
    ...
    ## Store Connect
    Route::get('admin/store/connect', [StoreController::class, 'connectStore'])->name('admin.store.connect');
    Route::post('admin/store/connect', [StoreController::class, 'connectPathao'])->name('admin.store.connect.post');
    ...
    Route::get('admin/booking/operator/list/page', [BookingOperatorController::class, 'list'])->name('admin.booking.operator.list.page');
...
## Dispatch Item
Route::get('admin/dispatch/item/index', [DispatchItemController::class, 'index'])->name('admin.dispatch.item.index');
Route::get('admin/dispatch/item/create', [DispatchItemController::class, 'create'])->name('admin.dispatch.item.create');
Route::get('admin/dispatch/item/edit/{id}', [DispatchItemController::class, 'edit'])->name('admin.dispatch.item.edit');
Route::post('admin/dispatch/item/store', [DispatchItemController::class, 'store'])->name('admin.dispatch.item.store');
